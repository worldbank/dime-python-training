...
\begin{frame}{Introduction}
	...
	\begin{itemize}
		\item This session will introduce you to the very basics of Python
		\item We'll also review a web scraping exercise where you'll see how versatile Python is
		\item By the end of this session, you'll be able to write and review \textbf{basic} Python code
	\end{itemize}
...
\begin{frame}{Basic syntax - Looping}
	...
	\begin{itemize}	
		\item Python differentiates what is inside the \text{for} loop and where it ends with an indentation space
