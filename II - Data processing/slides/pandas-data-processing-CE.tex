...
\begin{frame}{Reading and exploring data}
	...
	\begin{multicols}{2}
		...
		\begin{itemize}
			\item Running the dataframe name as a command will print it. If the dataframe has too many rows or columns, Python will print only the first and last rows and columns.
...
\begin{frame}{Indexing and filtering}
	...
	Note that the index of the outcome dataframe doesn't start with zero anymore. We'll explain more about this in a while.
